...
/**
 * Encapsulate and return the Response object
 */
class Response {
     ...
     */
    file(filePath, fileName, errorMsg) {

        if (!filePath)throw new Error('filePath should be required in res.file()');
        ...
        if (fs.existsSync(filePath)) {
            ...
            this.end(errorMsg ? errorMsg : "file not exist!");
        }
    }
